...
<div class="w1520 index-con">
    ...
    @foreach ($categoryWithImages as $categoryImages)
        @if (\App\Helpers\General::checkCategory($categoryImages['category']['name']) == \App\Category::GRAPHIC_DESIGN
        || \App\Helpers\General::checkCategory($categoryImages['category']['name']) == \App\Category::TEMPLATES
        || \App\Helpers\General::checkCategory($categoryImages['category']['name']) == \App\Category::ART_FONT)
            <!-- Graphic Design -->
    <div class="main-con {{ \App\Helpers\General::getDivClassIndex($categoryImages['category']['name']) }}">
        <h3 class="main-title">
            <a href="{{ $categoryImages['category']['slug'] }}.html" class="element-click" data-type="Graphic_Design">
                @if(\App\Helpers\General::checkCategory($categoryImages['category']['name']) == \App\Category::GRAPHIC_DESIGN) Graphic Design @endif
                @if(\App\Helpers\General::checkCategory($categoryImages['category']['name']) == \App\Category::TEMPLATES) Excellent Templates @endif
                @if(\App\Helpers\General::checkCategory($categoryImages['category']['name']) == \App\Category::ART_FONT) Editable Art Fonts @endif
            </a>
            <!--                GRAPHIC DESIGN1-->
            <p>{{ $categoryImages['totals'] }}
                @if(\App\Helpers\General::checkCategory($categoryImages['category']['name']) == \App\Category::GRAPHIC_DESIGN) PNG Images For Free Download @endif
                @if(\App\Helpers\General::checkCategory($categoryImages['category']['name']) == \App\Category::TEMPLATES) Templates for Download @endif
                @if(\App\Helpers\General::checkCategory($categoryImages['category']['name']) == \App\Category::ART_FONT) Curated Art Fonts Free Download @endif
            </p>
        </h3>
        <div class="main-body">
            <ul class="mb-box clearfix">
                ...
                <li>
                    ...
                    <!-- png -->
                    <div class="{{ \App\Helpers\General::getPicBoxClass($categoryImages['category']['name']) }}">
                    ...
                    <div class="pic-infor clearfix">
                        ...
                        @endif
                        @if(\App\Helpers\General::checkCategory($categoryImages['category']['name']) == \App\Category::TEMPLATES)
                ...
                <li>
                    <div class="mb-more">
                        ...
                        <h4>
                            @if(\App\Helpers\General::checkCategory($categoryImages['category']['name']) == \App\Category::GRAPHIC_DESIGN) PNG Images @endif
                            @if(\App\Helpers\General::checkCategory($categoryImages['category']['name']) == \App\Category::TEMPLATES) Templates @endif
                            @if(\App\Helpers\General::checkCategory($categoryImages['category']['name']) == \App\Category::ART_FONT) Curated Art Fonts Free Download @endif
                        </h4>
    ...
    @if (\App\Helpers\General::checkCategory($categoryImages['category']['name']) == \App\Category::POWER_POINT)
    <!--        PPT -->
    ...
    @if (\App\Helpers\General::checkCategory($categoryImages['category']['name']) == \App\Category::BACK_GROUND)
    ...
    @if (\App\Helpers\General::checkCategory($categoryImages['category']['name']) == \App\Category::ICON)
    <!-- Popular Icons -->
